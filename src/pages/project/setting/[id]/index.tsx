...
export default function Setting() {
  ...
  return (
    <main className="container py-10 mx-auto max-w-5xl">
      <div className="flex flex-col justify-center gap-5 max-w-[300px]">
        <div className="text-2xl font-bold tracking-tight">General</div>
        <hr />
        <div>
        ...
        <div className="border-[1px] border-red-400 flex flex-col justify-center rounded-lg">
          <div className="flex items-center justify-between p-5 flex-wrap">
            <div>
              ...
              <p className="text-sm">
                Once you delete a respository, there is no going back, Please be
                certain.
              </p>
            </div>
            {loading ? (
